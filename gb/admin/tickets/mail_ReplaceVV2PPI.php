...
<p>Спектакль «Вешние воды», назначенный на 15 февраля 2014 года заменён на спектакль «Повесть о том, как поссорился Иван Иванович с Иваном Никифоровичем» Н. Гоголя по техническим причинам. Спектакль состоится в тот же день в 18:00.</p>
<p class=bold>Приносим Вам свои извинения</p>
<p>Если Вы хотите отказаться от спектакля, напишите, пожалуйста, нам письмо.</p>
<br>
...
//  header("Location: index.php");
  ...
  {
  ?>
  <p class=zag2>Ошибка отправки:</p> 
  <p class=text>Контрольная сумма не совпадает.</p>
  <p><a href=# class=link>Закрыть</a></p>
  <?
  };
?>