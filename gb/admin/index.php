<?php
  ...
  //Отредактировани Гришей Кимом
  echo "<div><a href='tickets' class=link>Перейти к работе с архивом билетов</a></div>";
  ...
  while($guest = mysql_fetch_array($gst))
  {
    ...
    echo "<tr valign=top><td><p class=zag2>Спектакль:</td><td colspan=5><p>".$SPEKTAKL[$guest['sp']]."</td></tr>";
